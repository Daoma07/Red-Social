...
/**
 * Clase que representa una publicación anclada en el sistema.
...
public class Anclada extends Publicacion {
    ...
    /**
     * Constructor que recibe un administrador, la fecha y hora de creación, el título, el contenido y la fecha y hora de edición de la publicación anclada.
     * @param admin El administrador asociado a la publicación anclada.
     * @param fechaHoraCreacion La fecha y hora de creación de la publicación anclada.
     * @param titulo El título de la publicación anclada.
     * @param contenido El contenido de la publicación anclada.
     * @param fechaHoraEdicion La fecha y hora de edición de la publicación anclada.
     */
    ...
    /**
     * Constructor que recibe un administrador, el ID, la fecha y hora de creación, el título, el contenido y la fecha y hora de edición de la publicación anclada.
     * @param admin El administrador asociado a la publicación anclada.
